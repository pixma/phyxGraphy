...
void __stdcall InitAppControls(HWND hWnd, HINSTANCE hInst){
    ...
    ghGlWindow = CreateWindowEx (
           ...
           "glWindow",         /* Classname */
           "phyxGraphy : Scene Window : Annim Banerjee",       /* Title Text */
...
void __stdcall RenderScene(){
     ...
     char sz[100];
     wsprintf(sz, "phyxGraphy : Scene Window : Annim Banerjee. (c)2012 : Window Width: %d \tWindow Height: %d",(rcClient.right - rcClient.left), rcClient.bottom - rcClient.top);
