...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int nCmdShow){
    ...
    gMainWindowHandle = CreateWindow(TEXT("phyxgraphywindow"), TEXT("phyxGraphy : Line Drawing: Bresenhams Alogorithm"), WS_VISIBLE|WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 750, 550, NULL, NULL, hInstance, NULL);
...
void __stdcall bresenhamLine(int x0, int y0, int x1, int y1){
...
//     glPushMatrix();     
     ...
     insertAtListBox((int)x, (int)y, (int) p);
     glEnd();
...
void __stdcall insertAtListBox(int x, int y, int p){
     //hListBoxAxisX, hListBoxAxisY
     char ch[100];
     wsprintf(ch, "P = %d: \t\t x = %d", p, x);
